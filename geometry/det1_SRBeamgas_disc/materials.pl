...
use utils;
use materials;
######This is currently just copied from old beampipe design-- need to create SiC material, not sure if beam pipe is still BeAl####
# Help Message
sub help()
{
	print "\n Usage: \n";
...
sub define_material
{
	...
	$mat{"description"}   = "Scintillator";
	$mat{"density"}       = "1.032";  #in g/cm3
	$mat{"ncomponents"}   = "2";
	$mat{"components"}    = "G4_C 0.47 G4_H 0.53";
